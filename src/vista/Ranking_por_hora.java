 ...
 * @author RojeruSan
 */
public class Ranking_por_hora extends javax.swing.JFrame {

    
    control con = new control();

    public Ranking_por_hora() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ranking_por_hora.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ranking_por_hora().setVisible(true);
            }
        });
    }

 ...
 * @author RojeruSan
 */
public class Ranking_por_ano extends javax.swing.JFrame {

    
    control con = new control();

    public Ranking_por_ano() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 80, 1020, 570));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ranking_por_ano.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ranking_por_ano().setVisible(true);
            }
        });
    }

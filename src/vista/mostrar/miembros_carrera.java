 ...
 * @author RojeruSan
 */
public class miembros_carrera extends javax.swing.JFrame {

    
    control con = new control();

    public miembros_carrera() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton6.setText("Empezar Carrera");
        ...
        jLabel2.setText("Miembros de la Carrera");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 90, 390, 60));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 307, 850, 400));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(miembros_carrera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new miembros_carrera().setVisible(true);
            }
        });
    }

 ...
 * @author RojeruSan
 */
public class Parada_boxes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Paradas a Boxes del Equipo:");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 130, 460, 60));
        ...
        jLabel3.setText("a");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 130, 70, 60));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Parada_boxes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Parada_boxes().setVisible(true);
            }
        });
    }

 ...
 * @author RojeruSan
 */
public class Condicion_auto extends javax.swing.JFrame {

    
    control con = new control();

    public Condicion_auto() {
        initComponents();
    ...
    private void initComponents() {
        ...
        pnlMenu.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 520, 195, 50));
        ...
        jButton7.setText("Paradas a Boxes");
        ...
        pnlMenu.add(jButton9, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 450, 195, 50));
        ...
        jLabel2.setText("Condición del Auto, Equipo:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Condicion_auto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Condicion_auto().setVisible(true);
            }
        });
    }

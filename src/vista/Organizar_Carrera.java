 ...
 * @author RojeruSan
 */
public class Organizar_Carrera extends javax.swing.JFrame {

    
    control con = new control();

    public Organizar_Carrera() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Organizar_Carrera.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Organizar_Carrera().setVisible(true);
            }
        });
    }

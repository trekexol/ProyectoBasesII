 ...
 * @author RojeruSan
 */
public class Insert_Conductor extends javax.swing.JFrame {

    
    control con = new control();

    public Insert_Conductor() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 70, 210, 60));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Insert_Conductor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Insert_Conductor().setVisible(true);
            }
        });
    }
